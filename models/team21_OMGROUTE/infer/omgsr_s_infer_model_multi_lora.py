...
class OMGSR_S_Infer(torch.nn.Module):
    ...
    def merge_current_lora(self, is_bicubic=False):
        ...
        self.vae.encoder.merge_adapter()
        self.unet.merge_adapter()
        print(f"Merged adapter: {active_adapter} for maximum speed.")

    def unmerge_current_lora(self):
        self.vae.encoder.unmerge_adapter()
        self.unet.unmerge_adapter()
        print("Unmerged current adapters.")
